...
param protein := sum{food in 1..FOODS} sum{nutrient in {13}} c[food,nutrient] * sum{meal in 1..MEALS} x[food,meal];

/* 14) Fats, Total Fat (g) */
param fat := sum{food in 1..FOODS} sum{nutrient in {14}} c[food,nutrient] * sum{meal in 1..MEALS} x[food,meal];

/* 15) Carbohydrates, By Difference (g) */
param carbohydratesByDiff := sum{food in 1..FOODS} sum{nutrient in {15}} c[food,nutrient] * sum{meal in 1..MEALS} x[food,meal];

/* 16) Energy, Gross (kcal) */
param energyGross := sum{food in 1..FOODS} sum{nutrient in {16}} c[food,nutrient] * sum{meal in 1..MEALS} x[food,meal];

/* 17) Other, Alcohol (g) */
param alcohol := sum{food in 1..FOODS} sum{nutrient in {17}} c[food,nutrient] * sum{meal in 1..MEALS} x[food,meal];

/* 18) Other, Water (g) */
param water := sum{food in 1..FOODS} sum{nutrient in {18}} c[food,nutrient] * sum{meal in 1..MEALS} x[food,meal];

/* 19) Carbohydrates, Fiber (g) */
param fiber := sum{food in 1..FOODS} sum{nutrient in {19}} c[food,nutrient] * sum{meal in 1..MEALS} x[food,meal];

/* 20) Minerals, Calcium (mg) */
param calcium := sum{food in 1..FOODS} sum{nutrient in {20}} c[food,nutrient] * sum{meal in 1..MEALS} x[food,meal];

/* 21) Minerals, Iron (mg) */
param iron := sum{food in 1..FOODS} sum{nutrient in {21}} c[food,nutrient] * sum{meal in 1..MEALS} x[food,meal];

/* 22) Minerals, Magnesium (mg) */
param magnesium := sum{food in 1..FOODS} sum{nutrient in {22}} c[food,nutrient] * sum{meal in 1..MEALS} x[food,meal];

/* 23) Minerals, Phosphorus (mg) */
param phosphorus := sum{food in 1..FOODS} sum{nutrient in {23}} c[food,nutrient] * sum{meal in 1..MEALS} x[food,meal];

/* 24) Minerals, Potassium (mg) */
param potassium := sum{food in 1..FOODS} sum{nutrient in {24}} c[food,nutrient] * sum{meal in 1..MEALS} x[food,meal];

/* 25) Minerals, Sodium (mg) */
param sodium := sum{food in 1..FOODS} sum{nutrient in {25}} c[food,nutrient] * sum{meal in 1..MEALS} x[food,meal];

/* 26) Minerals, Zinc (mg) */
param zinc := sum{food in 1..FOODS} sum{nutrient in {26}} c[food,nutrient] * sum{meal in 1..MEALS} x[food,meal];

/* 27) Minerals, Copper (mg) */
param copper := sum{food in 1..FOODS} sum{nutrient in {27}} c[food,nutrient] * sum{meal in 1..MEALS} x[food,meal];

/* 28) Minerals, Manganese (mg) */
param manganese := sum{food in 1..FOODS} sum{nutrient in {28}} c[food,nutrient] * sum{meal in 1..MEALS} x[food,meal];

/* 29) Minerals, Selenium (µg) */
param selenium := sum{food in 1..FOODS} sum{nutrient in {29}} c[food,nutrient] * sum{meal in 1..MEALS} x[food,meal];

/* 30) Vitamins, A, RAE (µg) */
param vitaminA := sum{food in 1..FOODS} sum{nutrient in {30}} c[food,nutrient] * sum{meal in 1..MEALS} x[food,meal];

/* 31) Vitamins, E (mg) */
param vitaminE := sum{food in 1..FOODS} sum{nutrient in {31}} c[food,nutrient] * sum{meal in 1..MEALS} x[food,meal];

/* 32) Vitamins, D (µg) */
param vitaminD := sum{food in 1..FOODS} sum{nutrient in {32}} c[food,nutrient] * sum{meal in 1..MEALS} x[food,meal];

/* 33) Vitamins, C (mg) */
param vitaminC := sum{food in 1..FOODS} sum{nutrient in {33}} c[food,nutrient] * sum{meal in 1..MEALS} x[food,meal];

/* 34) Vitamins, Thiamin (mg) */
param thiamin := sum{food in 1..FOODS} sum{nutrient in {34}} c[food,nutrient] * sum{meal in 1..MEALS} x[food,meal];

/* 35) Vitamins, Riboflavin (mg) */
param riboflavin := sum{food in 1..FOODS} sum{nutrient in {35}} c[food,nutrient] * sum{meal in 1..MEALS} x[food,meal];

/* 36) Vitamins, Niacin (mg) */
param niacin := sum{food in 1..FOODS} sum{nutrient in {36}} c[food,nutrient] * sum{meal in 1..MEALS} x[food,meal];

/* 37) Vitamins, Pantothenic Acid (mg) */
param pantothenicAcid := sum{food in 1..FOODS} sum{nutrient in {37}} c[food,nutrient] * sum{meal in 1..MEALS} x[food,meal];

/* 38) Vitamins, B6 (mg) */
param vitaminB6 := sum{food in 1..FOODS} sum{nutrient in {38}} c[food,nutrient] * sum{meal in 1..MEALS} x[food,meal];

/* 39) Vitamins, B12 (µg) */
param vitaminB12 := sum{food in 1..FOODS} sum{nutrient in {39}} c[food,nutrient] * sum{meal in 1..MEALS} x[food,meal];

/* 40) Vitamins, Choline (mg) */
param choline := sum{food in 1..FOODS} sum{nutrient in {40}} c[food,nutrient] * sum{meal in 1..MEALS} x[food,meal];

/* 41) Vitamins, K (µg) */
param vitaminK := sum{food in 1..FOODS} sum{nutrient in {41}} c[food,nutrient] * sum{meal in 1..MEALS} x[food,meal];

/* 42) Vitamins, Folate, DFE (µg) */
param folate := sum{food in 1..FOODS} sum{nutrient in {42}} c[food,nutrient] * sum{meal in 1..MEALS} x[food,meal];

/* 43) Fats, Cholesterol (mg) */
param cholesterol := sum{food in 1..FOODS} sum{nutrient in {43}} c[food,nutrient] * sum{meal in 1..MEALS} x[food,meal];

/* 44) Fats, Saturated Fat, SFA (g) */
param sfa := sum{food in 1..FOODS} sum{nutrient in {44}} c[food,nutrient] * sum{meal in 1..MEALS} x[food,meal];

/* 45) Fats, Lauric Acid, 12:0 (g) */
param lauric := sum{food in 1..FOODS} sum{nutrient in {45}} c[food,nutrient] * sum{meal in 1..MEALS} x[food,meal];

/* 46) Fats, Myristic Acid, 14:0 (g) */
param myristic := sum{food in 1..FOODS} sum{nutrient in {46}} c[food,nutrient] * sum{meal in 1..MEALS} x[food,meal];

/* 47) Fats, Palmitic Acid, 16:0 (g) */
param palmitic := sum{food in 1..FOODS} sum{nutrient in {47}} c[food,nutrient] * sum{meal in 1..MEALS} x[food,meal];

/* 48) Fats, Stearic Acid, 18:0 (g) */
param stearic := sum{food in 1..FOODS} sum{nutrient in {48}} c[food,nutrient] * sum{meal in 1..MEALS} x[food,meal];

/* 49) Fats, Linoleic Acid, LA, 18:2 n-6 (g) */
param la := sum{food in 1..FOODS} sum{nutrient in {49}} c[food,nutrient] * sum{meal in 1..MEALS} x[food,meal];

/* 50) Fats, Alpha-linolenic Acid, ALA, 18:3 n-3 (g) */
param ala := sum{food in 1..FOODS} sum{nutrient in {50}} c[food,nutrient] * sum{meal in 1..MEALS} x[food,meal];

/* 51) Fats, Docosahexaenoic Acid, DHA, 22:6 n-3 (g) */
param dha := sum{food in 1..FOODS} sum{nutrient in {51}} c[food,nutrient] * sum{meal in 1..MEALS} x[food,meal];

/* 52) Fats, Eicosapentaenoic Acid, EPA, 20:5 n-3 (g) */
param epa := sum{food in 1..FOODS} sum{nutrient in {52}} c[food,nutrient] * sum{meal in 1..MEALS} x[food,meal];

/* 53) Fats, Monounsaturated Fat, MUFA (g) */
param mufa := sum{food in 1..FOODS} sum{nutrient in {53}} c[food,nutrient] * sum{meal in 1..MEALS} x[food,meal];

/* 54) Fats, Polyunsaturated Fat, PUFA (g) */
param pufa := sum{food in 1..FOODS} sum{nutrient in {54}} c[food,nutrient] * sum{meal in 1..MEALS} x[food,meal];
