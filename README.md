...
Installing
    ...
    1. Download snack-861-app.zip from https://xjrga.github.io/releases/
    2. unzip snack-861-app.zip
    3. cd snack-861
    4. java -jar snack-861.jar (if you are on windows double click on jar file)
