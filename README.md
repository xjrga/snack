...
Installing
    ...
    1. Download snack-690-app.zip from https://xjrga.github.io/releases/
    2. unzip snack-690-app.zip
    3. cd snack-690
    4. java -jar snack-690.jar (if you are on windows double click on jar file) 
