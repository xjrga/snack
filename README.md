...
Installing
    ...
    1. Download snack-730-app.zip from https://xjrga.github.io/releases/
    2. unzip snack-730-app.zip
    3. cd snack-730
    4. java -jar snack-730.jar (if you are on windows double click on jar file) 
