...
Installing
    ...
    1. Download snack-800-app.zip from https://xjrga.github.io/releases/
    2. unzip snack-800-app.zip
    3. cd snack-800
    4. java -jar snack-800.jar (if you are on windows double click on jar file)
