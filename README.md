...
Installing
    ...
    1. Download snack-1250-app.zip from https://xjrga.github.io
    2. unzip snack-1250-app.zip
    3. cd snack-1250
    4. java -jar snack-1250.jar (if you are on windows double click on jar file)
