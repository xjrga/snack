...
Installing
    ...
    1. Download Snack-625.zip from https://sourceforge.net/projects/snackmix
    2. unzip Snack-625.zip
    3. cd Snack-625
    4. java -jar Snack-625.jar (if you are on windows double click on jar file) 
