...
Installing
    ...
    1. Download snack-830-app.zip from https://xjrga.github.io/releases/
    2. unzip snack-830-app.zip
    3. cd snack-830
    4. java -jar snack-830.jar (if you are on windows double click on jar file)
