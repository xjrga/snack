...
Installing
    ...
    1. Download snack-870-app.zip from https://xjrga.github.io/releases/
    2. unzip snack-870-app.zip
    3. cd snack-870
    4. java -jar snack-870.jar (if you are on windows double click on jar file)
