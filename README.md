...
Installing
    ...
    1. Download snack-810-app.zip from https://xjrga.github.io/releases/
    2. unzip snack-810-app.zip
    3. cd snack-810
    4. java -jar snack-810.jar (if you are on windows double click on jar file)
