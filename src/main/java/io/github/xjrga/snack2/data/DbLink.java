...
public class DbLink {
    ...
    public List<Map<String, Object>> Food_Select_Details(Integer Precision) throws SQLException {
        ...
        while (rs.next()) {
            ...
            row.put("Category", rs.getObject(1));
            row.put("Name", rs.getObject(2));
            row.put(Nutrient.WEIGHT.getLabel(), rs.getObject(3));
            row.put(Nutrient.ENERGYGROSS.getLabel(), rs.getObject(4));
            row.put(Nutrient.ENERGYDIGESTIBLE.getLabel(), rs.getObject(5));
            row.put(Nutrient.ENERGYNOPROTEIN.getLabel(), rs.getObject(6));
            ...
            row.put(Nutrient.PANTOTHENIC.getLabel(), rs.getObject(36));
            ...
            row.put(Nutrient.SATURATED.getLabel(), rs.getObject(43));
            row.put(Nutrient.DHA.getLabel(), rs.getObject(44));
            row.put(Nutrient.EPA.getLabel(), rs.getObject(45));
            row.put(Nutrient.MONOUNSATURATED.getLabel(), rs.getObject(46));
            row.put(Nutrient.POLYUNSATURATED.getLabel(), rs.getObject(47));
            row.put(Nutrient.LINOLEIC.getLabel(), rs.getObject(48));
            row.put(Nutrient.ALPHALINOLENIC.getLabel(), rs.getObject(49));
            ...
            row.put("CategoryId", rs.getObject(53));
            row.put("FoodId", rs.getObject(54));
            list.add(row);
        }
        proc.close();
        return list;
