...
public class PercentNutrientConstraintSelect implements SqlCallMixid<Map<String, Object>> {

  private final Connection connection;

  public PercentNutrientConstraintSelect() {
  ...
  public List<Map<String, Object>> execute(String mixid) {
    ...
    try (CallableStatement proc =
        connection.prepareCall("{CALL public.PercentNutrientConstraint_Select( ? )}")) {
