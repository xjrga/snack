...
import io.github.xjrga.snack.data.DriSelect;
import io.github.xjrga.snack.dataobject.CoefficientMod;
import java.util.List;

public class MathProgParamD {
  private final String paramC;

  public MathProgParamD() {
    List<CoefficientMod> coefficients = (new DriSelect()).apply();
  ...
  private String printFirstRow(CoefficientMod o) {
    ...
    return String.format(pattern.toString(), "param d:", o.getN10000(), o.getN10001(),
