...
import io.github.xjrga.snack.lp.mathprog.MathProgPrintOut;
...
public class Main {
  ...
  private JMenuBar get_menubar() {
    ...
    checkBoxCplex.setText("Write model to file in CPLEX LP format");
    checkBoxMathProg.setText("Write model to file in GNU MathProg modeling language");
  ...
  private void process_evt_btn_solve() {
    try {
      ...
      MathProgPrintOut mathprog = new MathProgPrintOut(mixid);
      ...
      mathprog.addObjectiveFunction(new MathProgObjectiveFunction(objectiveFunctionName, mpoint1));
      ...
      for (HashMap row : nutrient_constraints) {
        ...
        try {
          ...
          mathprog.addNutrientQuantityConstraint(
      ...
      for (HashMap row : foodnutrientRhsList) {
        ...
        try {
          ...
          mathprog.addFoodQuantityConstraint(
      ...
      for (HashMap row : foodnutrientratioRhsList) {
        ...
        try {
          ...
          mathprog.addFoodRatioConstraint(
      ...
      for (HashMap row : nutrientratioRhsList) {
        ...
        try {
          ...
          mathprog.addNutrientRatioConstraint(
      ...
      for (HashMap row : percentnutrientRhsList) {
        ...
        try {
          ...
          MathProgPoint mpoint8 =
              new MathProgPoint(
                  foodPosition.getPosition(foodid), nutrientPosition.getPosition(nutrientid));
          mathprog.addFoodQuantityPercentageConstraint(
      ...
      mathprog.setFoodCount(mixFoodEntries.size());
      lpsolve.setFoodNameComment(foodNameComment);
      cplex.setFoodNameComment(foodNameComment);
      mathprog.setFoodNameComment(foodNameComment);
      // solve
      if (lpmodel.solve()) {
        ...
        feasibleMessage.append(mathprog.getProblem());
        ...
        if (checkBoxLpsolve.isSelected()) {
          ...
          Utilities.write_to_new_file(lpsolvefile, lpsolve.getProblem());
        }
        if (checkBoxCplex.isSelected()) {
          String cplexfile = "log/snack_glpk_" + Utilities.getCurrentTimeMillisTxt() + ".lp";
          Utilities.write_to_new_file(cplexfile, cplex.getProblem());
        }
        if (checkBoxMathProg.isSelected()) {
          String mathprogfile = "log/snack_glpk_" + Utilities.getCurrentTimeMillisTxt() + ".mod";
          Utilities.write_to_new_file(mathprogfile, mathprog.getProblem());
        }
        reload_tblmdl_editor_results();
        reload_tblmdl_editor_rda_check();
        reload_tblmdl_food_comparison();
        ...
        infeasibleMessage.append(mathprog.getProblem());
