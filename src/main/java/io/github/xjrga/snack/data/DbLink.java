...
public class DbLink {
    ...
    public List<Map<String, Object>> MixResult_Select(Integer MixId, Integer Precision) throws SQLException {
        ...
        while (rs.next()) {
            ...
            row.put(Nutrient.ENERGYNOPROTEIN.getLabel(), rs.getObject(49));
            row.put(Nutrient.ENERGYCARBOHYDRATE.getLabel(), rs.getObject(50));
            row.put(Nutrient.ENERGYPROTEIN.getLabel(), rs.getObject(51));
            row.put(Nutrient.ENERGYFAT.getLabel(), rs.getObject(52));
            row.put(Nutrient.ENERGYALCOHOL.getLabel(), rs.getObject(53));
            //
            list.add(row);
        }
        proc.close();
    ...
    public List<Map<String, Object>> Food_Select_Details(Integer Precision) throws SQLException {
        ...
        while (rs.next()) {
            ...
            row.put(Nutrient.ENERGYNOPROTEIN.getLabel(), rs.getObject(5));
            row.put(Nutrient.ENERGYCARBOHYDRATE.getLabel(), rs.getObject(6));
            row.put(Nutrient.ENERGYPROTEIN.getLabel(), rs.getObject(7));
            row.put(Nutrient.ENERGYFAT.getLabel(), rs.getObject(8));
            row.put(Nutrient.ENERGYALCOHOL.getLabel(), rs.getObject(9));
            ...
            row.put(Nutrient.FLUORIDE.getLabel(), rs.getObject(25));
            ...
            row.put(Nutrient.PANTOTHENIC.getLabel(), rs.getObject(35));
            ...
            row.put(Nutrient.SATURATED.getLabel(), rs.getObject(42));
            row.put(Nutrient.DHA.getLabel(), rs.getObject(43));
            row.put(Nutrient.EPA.getLabel(), rs.getObject(44));
            row.put(Nutrient.MONOUNSATURATED.getLabel(), rs.getObject(45));
            row.put(Nutrient.POLYUNSATURATED.getLabel(), rs.getObject(46));
            row.put(Nutrient.LINOLEIC.getLabel(), rs.getObject(47));
            row.put(Nutrient.ALPHALINOLENIC.getLabel(), rs.getObject(48));
