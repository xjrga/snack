...
public class DbLink {
  ...
  public List<FoodFactSelectForDataInputDataObject> FoodFact_Select_ForDataInput(
    ...
    ResultSet rs = proc.executeQuery();
    while (rs.next()) {
      FoodFactSelectForDataInputDataObject foodFactSelectForDataInputDataObject =
          new FoodFactSelectForDataInputDataObject();
  ...
  public List<FoodFactSelectForCheckCoefficientsDataObject> FoodFact_Select_ForCheckCoefficients(
    ...
    ResultSet rs = proc.executeQuery();
    while (rs.next()) {
      FoodFactSelectForCheckCoefficientsDataObject foodFactSelectForCheckCoefficientsDataObject =
  ...
  public List<MixFoodFactCoefficient> getMixCoefficients(String MixId) throws SQLException {
    ...
    CallableStatement proc;
    proc = connection.prepareCall("{CALL public.getMixCoefficients( ? )}");
    proc.setString(1, MixId);
    ResultSet rs = proc.executeQuery();
    while (rs.next()) {
