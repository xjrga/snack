...
public class Food_stats implements Round_up, Reload_mixid {
    ...
    try {
      ...
      list.forEach(
          row -> {
            ...
            Formatted essentialfatratio =
                new Formatted((Double) row.get("ESSENTIALFATRATIO"), precision);
            Formatted electrolyteratio =
                new Formatted((Double) row.get("ELECTROLYTERATIO"), precision);
