...
public class MixResultsReport {
    ...
    public void create(MixDO mixDataObject) {
        try (FileWriter fileWriter = new FileWriter("models/mixresults.csv")) {
            ...
            CSVFormat csvFormat = CSVFormat.DEFAULT
                    .builder()
                    .setCommentMarker('#')
                    .setHeaderComments("Mix Results Report", comment.toString(), LocalDateTime.now())
                    // .setHeader(rs)
            ...
            String c81 = rs.getMetaData().getColumnName(81);
            String c82 = rs.getMetaData().getColumnName(82);
            String c83 = rs.getMetaData().getColumnName(83);
            String c84 = rs.getMetaData().getColumnName(84);
            String c85 = rs.getMetaData().getColumnName(85);
            ...
            String c90 = rs.getMetaData().getColumnName(90);
            String c91 = rs.getMetaData().getColumnName(91);
            while (rs.next()) {
                String x1 = rs.getString(1);
                String x2 = rs.getString(2);
                String x3 = rs.getString(3);
                BigDecimal x4 = rs.getBigDecimal(4);
                csvPrinter.printRecord(x1, x2, x3, c4, U.strip(x4));
                BigDecimal x5 = rs.getBigDecimal(5);
                csvPrinter.printRecord(x1, x2, x3, c5, U.strip(x5));
                BigDecimal x6 = rs.getBigDecimal(6);
                csvPrinter.printRecord(x1, x2, x3, c6, U.strip(x6));
                BigDecimal x7 = rs.getBigDecimal(7);
                csvPrinter.printRecord(x1, x2, x3, c7, U.strip(x7));
                BigDecimal x8 = rs.getBigDecimal(8);
                csvPrinter.printRecord(x1, x2, x3, c8, U.strip(x8));
                BigDecimal x9 = rs.getBigDecimal(9);
                csvPrinter.printRecord(x1, x2, x3, c9, U.strip(x9));
                BigDecimal x10 = rs.getBigDecimal(10);
                csvPrinter.printRecord(x1, x2, x3, c10, U.strip(x10));
                BigDecimal x11 = rs.getBigDecimal(11);
                csvPrinter.printRecord(x1, x2, x3, c11, U.strip(x11));
                BigDecimal x12 = rs.getBigDecimal(12);
                csvPrinter.printRecord(x1, x2, x3, c12, U.strip(x12));
                BigDecimal x13 = rs.getBigDecimal(13);
                csvPrinter.printRecord(x1, x2, x3, c13, U.strip(x13));
                BigDecimal x14 = rs.getBigDecimal(14);
                csvPrinter.printRecord(x1, x2, x3, c14, U.strip(x14));
                BigDecimal x15 = rs.getBigDecimal(15);
                csvPrinter.printRecord(x1, x2, x3, c15, U.strip(x15));
                BigDecimal x16 = rs.getBigDecimal(16);
                csvPrinter.printRecord(x1, x2, x3, c16, U.strip(x16));
                BigDecimal x17 = rs.getBigDecimal(17);
                csvPrinter.printRecord(x1, x2, x3, c17, U.strip(x17));
                BigDecimal x18 = rs.getBigDecimal(18);
                csvPrinter.printRecord(x1, x2, x3, c18, U.strip(x18));
                BigDecimal x19 = rs.getBigDecimal(19);
                csvPrinter.printRecord(x1, x2, x3, c19, U.strip(x19));
                BigDecimal x20 = rs.getBigDecimal(20);
                csvPrinter.printRecord(x1, x2, x3, c20, U.strip(x20));
                BigDecimal x21 = rs.getBigDecimal(21);
                csvPrinter.printRecord(x1, x2, x3, c21, U.strip(x21));
                BigDecimal x22 = rs.getBigDecimal(22);
                csvPrinter.printRecord(x1, x2, x3, c22, U.strip(x22));
                BigDecimal x23 = rs.getBigDecimal(23);
                csvPrinter.printRecord(x1, x2, x3, c23, U.strip(x23));
                BigDecimal x24 = rs.getBigDecimal(24);
                csvPrinter.printRecord(x1, x2, x3, c24, U.strip(x24));
                BigDecimal x25 = rs.getBigDecimal(25);
                csvPrinter.printRecord(x1, x2, x3, c25, U.strip(x25));
                BigDecimal x26 = rs.getBigDecimal(26);
                csvPrinter.printRecord(x1, x2, x3, c26, U.strip(x26));
                BigDecimal x27 = rs.getBigDecimal(27);
                csvPrinter.printRecord(x1, x2, x3, c27, U.strip(x27));
                BigDecimal x28 = rs.getBigDecimal(28);
                csvPrinter.printRecord(x1, x2, x3, c28, U.strip(x28));
                BigDecimal x29 = rs.getBigDecimal(29);
                csvPrinter.printRecord(x1, x2, x3, c29, U.strip(x29));
                BigDecimal x30 = rs.getBigDecimal(30);
                csvPrinter.printRecord(x1, x2, x3, c30, U.strip(x30));
                BigDecimal x31 = rs.getBigDecimal(31);
                csvPrinter.printRecord(x1, x2, x3, c31, U.strip(x31));
                BigDecimal x32 = rs.getBigDecimal(32);
                csvPrinter.printRecord(x1, x2, x3, c32, U.strip(x32));
                BigDecimal x33 = rs.getBigDecimal(33);
                csvPrinter.printRecord(x1, x2, x3, c33, U.strip(x33));
                BigDecimal x34 = rs.getBigDecimal(34);
                csvPrinter.printRecord(x1, x2, x3, c34, U.strip(x34));
                BigDecimal x35 = rs.getBigDecimal(35);
                csvPrinter.printRecord(x1, x2, x3, c35, U.strip(x35));
                BigDecimal x36 = rs.getBigDecimal(36);
                csvPrinter.printRecord(x1, x2, x3, c36, U.strip(x36));
                BigDecimal x37 = rs.getBigDecimal(37);
                csvPrinter.printRecord(x1, x2, x3, c37, U.strip(x37));
                BigDecimal x38 = rs.getBigDecimal(38);
                csvPrinter.printRecord(x1, x2, x3, c38, U.strip(x38));
                BigDecimal x39 = rs.getBigDecimal(39);
                csvPrinter.printRecord(x1, x2, x3, c39, U.strip(x39));
                BigDecimal x40 = rs.getBigDecimal(40);
                csvPrinter.printRecord(x1, x2, x3, c40, U.strip(x40));
                BigDecimal x41 = rs.getBigDecimal(41);
                csvPrinter.printRecord(x1, x2, x3, c41, U.strip(x41));
                BigDecimal x42 = rs.getBigDecimal(42);
                csvPrinter.printRecord(x1, x2, x3, c42, U.strip(x42));
                BigDecimal x43 = rs.getBigDecimal(43);
                csvPrinter.printRecord(x1, x2, x3, c43, U.strip(x43));
                BigDecimal x44 = rs.getBigDecimal(44);
                csvPrinter.printRecord(x1, x2, x3, c44, U.strip(x44));
                BigDecimal x45 = rs.getBigDecimal(45);
                csvPrinter.printRecord(x1, x2, x3, c45, U.strip(x45));
                BigDecimal x46 = rs.getBigDecimal(46);
                csvPrinter.printRecord(x1, x2, x3, c46, U.strip(x46));
                BigDecimal x47 = rs.getBigDecimal(47);
                csvPrinter.printRecord(x1, x2, x3, c47, U.strip(x47));
                BigDecimal x48 = rs.getBigDecimal(48);
                csvPrinter.printRecord(x1, x2, x3, c48, U.strip(x48));
                BigDecimal x49 = rs.getBigDecimal(49);
                csvPrinter.printRecord(x1, x2, x3, c49, U.strip(x49));
                BigDecimal x50 = rs.getBigDecimal(50);
                csvPrinter.printRecord(x1, x2, x3, c50, U.strip(x50));
                BigDecimal x51 = rs.getBigDecimal(51);
                csvPrinter.printRecord(x1, x2, x3, c51, U.strip(x51));
                BigDecimal x52 = rs.getBigDecimal(52);
                csvPrinter.printRecord(x1, x2, x3, c52, U.strip(x52));
                BigDecimal x53 = rs.getBigDecimal(53);
                csvPrinter.printRecord(x1, x2, x3, c53, U.strip(x53));
                BigDecimal x54 = rs.getBigDecimal(54);
                csvPrinter.printRecord(x1, x2, x3, c54, U.strip(x54));
                BigDecimal x55 = rs.getBigDecimal(55);
                csvPrinter.printRecord(x1, x2, x3, c55, U.strip(x55));
                BigDecimal x56 = rs.getBigDecimal(56);
                csvPrinter.printRecord(x1, x2, x3, c56, U.strip(x56));
                BigDecimal x57 = rs.getBigDecimal(57);
                csvPrinter.printRecord(x1, x2, x3, c57, U.strip(x57));
                BigDecimal x58 = rs.getBigDecimal(58);
                csvPrinter.printRecord(x1, x2, x3, c58, U.strip(x58));
                BigDecimal x59 = rs.getBigDecimal(59);
                csvPrinter.printRecord(x1, x2, x3, c59, U.strip(x59));
                BigDecimal x60 = rs.getBigDecimal(60);
                csvPrinter.printRecord(x1, x2, x3, c60, U.strip(x60));
                BigDecimal x61 = rs.getBigDecimal(61);
                csvPrinter.printRecord(x1, x2, x3, c61, U.strip(x61));
                BigDecimal x62 = rs.getBigDecimal(62);
                csvPrinter.printRecord(x1, x2, x3, c62, U.strip(x62));
                BigDecimal x63 = rs.getBigDecimal(63);
                csvPrinter.printRecord(x1, x2, x3, c63, U.strip(x63));
                BigDecimal x64 = rs.getBigDecimal(64);
                csvPrinter.printRecord(x1, x2, x3, c64, U.strip(x64));
                BigDecimal x65 = rs.getBigDecimal(65);
                csvPrinter.printRecord(x1, x2, x3, c65, U.strip(x65));
                BigDecimal x66 = rs.getBigDecimal(66);
                csvPrinter.printRecord(x1, x2, x3, c66, U.strip(x66));
                BigDecimal x67 = rs.getBigDecimal(67);
                csvPrinter.printRecord(x1, x2, x3, c67, U.strip(x67));
                BigDecimal x68 = rs.getBigDecimal(68);
                csvPrinter.printRecord(x1, x2, x3, c68, U.strip(x68));
                BigDecimal x69 = rs.getBigDecimal(69);
                csvPrinter.printRecord(x1, x2, x3, c69, U.strip(x69));
                BigDecimal x70 = rs.getBigDecimal(70);
                csvPrinter.printRecord(x1, x2, x3, c70, U.strip(x70));
                BigDecimal x71 = rs.getBigDecimal(71);
                csvPrinter.printRecord(x1, x2, x3, c71, U.strip(x71));
                BigDecimal x72 = rs.getBigDecimal(72);
                csvPrinter.printRecord(x1, x2, x3, c72, U.strip(x72));
                BigDecimal x73 = rs.getBigDecimal(73);
                csvPrinter.printRecord(x1, x2, x3, c73, U.strip(x73));
                BigDecimal x74 = rs.getBigDecimal(74);
                csvPrinter.printRecord(x1, x2, x3, c74, U.strip(x74));
                BigDecimal x75 = rs.getBigDecimal(75);
                csvPrinter.printRecord(x1, x2, x3, c75, U.strip(x75));
                BigDecimal x76 = rs.getBigDecimal(76);
                csvPrinter.printRecord(x1, x2, x3, c76, U.strip(x76));
                BigDecimal x77 = rs.getBigDecimal(77);
                csvPrinter.printRecord(x1, x2, x3, c77, U.strip(x77));
                BigDecimal x78 = rs.getBigDecimal(78);
                csvPrinter.printRecord(x1, x2, x3, c78, U.strip(x78));
                BigDecimal x79 = rs.getBigDecimal(79);
                csvPrinter.printRecord(x1, x2, x3, c79, U.strip(x79));
                BigDecimal x80 = rs.getBigDecimal(80);
                csvPrinter.printRecord(x1, x2, x3, c80, U.strip(x80));
                BigDecimal x81 = rs.getBigDecimal(81);
                csvPrinter.printRecord(x1, x2, x3, c81, U.strip(x81));
                BigDecimal x82 = rs.getBigDecimal(82);
                csvPrinter.printRecord(x1, x2, x3, c82, U.strip(x82));
                BigDecimal x83 = rs.getBigDecimal(83);
                csvPrinter.printRecord(x1, x2, x3, c83, U.strip(x83));
                BigDecimal x84 = rs.getBigDecimal(84);
                csvPrinter.printRecord(x1, x2, x3, c84, U.strip(x84));
                BigDecimal x85 = rs.getBigDecimal(85);
                csvPrinter.printRecord(x1, x2, x3, c85, U.strip(x85));
                BigDecimal x86 = rs.getBigDecimal(86);
                csvPrinter.printRecord(x1, x2, x3, c86, U.strip(x86));
                BigDecimal x87 = rs.getBigDecimal(87);
                csvPrinter.printRecord(x1, x2, x3, c87, U.strip(x87));
                BigDecimal x88 = rs.getBigDecimal(88);
                csvPrinter.printRecord(x1, x2, x3, c88, U.strip(x88));
                BigDecimal x89 = rs.getBigDecimal(89);
                csvPrinter.printRecord(x1, x2, x3, c89, U.strip(x89));
                BigDecimal x90 = rs.getBigDecimal(90);
                csvPrinter.printRecord(x1, x2, x3, c90, U.strip(x90));
                BigDecimal x91 = rs.getBigDecimal(91);
                csvPrinter.printRecord(x1, x2, x3, c91, U.strip(x91));
            }
        } catch (Exception e) {
