...
public class DRIAverageDeficiencyLhsTask implements Callable<LhsContainer> {

    private final String mixid;
    private final Integer lifestageid;
    private final Connection connection;

    public DRIAverageDeficiencyLhsTask(String mixid, Integer lifestageid) {
        this.mixid = mixid;
    ...
    public LhsContainer call() {
        ...
        try (CallableStatement proc = connection.prepareCall("{CALL public.dridev_sum_deficiency_lhs( ?, ? )}")) {
