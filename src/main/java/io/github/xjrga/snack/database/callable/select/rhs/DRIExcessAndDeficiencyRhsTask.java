package io.github.xjrga.snack.database.callable.select.rhs;
...
public class DRIExcessAndDeficiencyRhsTask implements Callable<List<Map<String, Object>>> {
    ...
    public DRIExcessAndDeficiencyRhsTask(String mixid, Integer lifestyleid) {
        this.mixid = mixid;
