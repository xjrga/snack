...
public class FileName {
  ...
  public FileName() {
    ...
    lpsolveFileName = "model/snack_lpsolve_" + time + ".lp";
    cplexFileName = "model/snack_cplex_" + time + ".lp";
    glpkFileName = "model/snack_glpk_" + time + ".mod";
    glpkFileNameExp = "model/snack_glpk_" + time + "_exp.mod";
