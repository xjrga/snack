...
public class TableModelMixDiff extends DefaultTableModel {

    public static int c = 0;
    private final DbLink dbLink;
    private Vector columns;

    public TableModelMixDiff(DbLink dbLink) {
        this.dbLink = dbLink;
    ...
    public void reload(Integer MixId1, Integer MixId2) {
        ...
        try {
            LinkedList list = (LinkedList) dbLink.Mix_GetDiff(MixId1, MixId2);
