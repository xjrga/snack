	...
	public void create( MixDO mixDataObject ) {
		...
		try ( FileWriter fileWriter = new FileWriter( "models/mixresults1.csv" ) ) {
			...
			CSVFormat csvFormat = CSVFormat.DEFAULT.builder().setCommentMarker( '#' )
					.setHeaderComments( "Mix Results Report #1", comment.toString(), LocalDateTime.now() )
					.setHeader( rs ).get();
			...
			while ( rs.next() ) {
				...
				csvPrinter.printRecord( x1, x2, x3, Utilities.strip( x4 ), Utilities.strip( x5 ), Utilities.strip( x6 ),
						...
						Utilities.strip( x11 ), Utilities.strip( x12 ), Utilities.strip( x13 ), Utilities.strip( x14 ),
						Utilities.strip( x15 ), Utilities.strip( x16 ), Utilities.strip( x17 ), Utilities.strip( x18 ),
						Utilities.strip( x19 ), Utilities.strip( x20 ), Utilities.strip( x21 ), Utilities.strip( x22 ),
						Utilities.strip( x23 ), Utilities.strip( x24 ), Utilities.strip( x25 ), Utilities.strip( x26 ),
						Utilities.strip( x27 ), Utilities.strip( x28 ), Utilities.strip( x29 ), Utilities.strip( x30 ),
						Utilities.strip( x31 ), Utilities.strip( x32 ), Utilities.strip( x33 ), Utilities.strip( x34 ),
						Utilities.strip( x35 ), Utilities.strip( x36 ), Utilities.strip( x37 ), Utilities.strip( x38 ),
						Utilities.strip( x39 ), Utilities.strip( x40 ), Utilities.strip( x41 ), Utilities.strip( x42 ),
						Utilities.strip( x43 ), Utilities.strip( x44 ), Utilities.strip( x45 ), Utilities.strip( x46 ),
						Utilities.strip( x47 ), Utilities.strip( x48 ), Utilities.strip( x49 ), Utilities.strip( x50 ),
						Utilities.strip( x51 ), Utilities.strip( x52 ), Utilities.strip( x53 ), Utilities.strip( x54 ),
						Utilities.strip( x55 ), Utilities.strip( x56 ), Utilities.strip( x57 ), Utilities.strip( x58 ),
						Utilities.strip( x59 ), Utilities.strip( x60 ), Utilities.strip( x61 ), Utilities.strip( x62 ),
						Utilities.strip( x63 ), Utilities.strip( x64 ), Utilities.strip( x65 ), Utilities.strip( x66 ),
						Utilities.strip( x67 ), Utilities.strip( x68 ), Utilities.strip( x69 ), Utilities.strip( x70 ),
						Utilities.strip( x71 ), Utilities.strip( x72 ), Utilities.strip( x73 ), Utilities.strip( x74 ),
