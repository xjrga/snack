 ...
 * @author jr
 */
public class TableMixResults extends JTable implements ShowCategory {
	...
	public void showCategory( int ordinal ) {
		...
		case 0 -> adjustWidth( 4, 10 );
		case 1 -> adjustWidth( 11, 14 );
		case 2 -> adjustWidth( 15, 17 );
		case 3 -> adjustWidth( 18, 23 );
		case 4 -> adjustWidth( 24, 30 );
		case 5 -> adjustWidth( 31, 36 );
		case 6 -> adjustWidth( 37, 49 );
	...
	public class Row {
		...
		public String getId_mix_id() {

			return id_mix_id;

		}

		public void setId_mix_id( String id_mix_id ) {

			this.id_mix_id = id_mix_id;
