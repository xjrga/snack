...
public class TableFoodFacts extends JTable implements ShowCategory {
        ...
        txtSearch.getDocument().addDocumentListener( new DocumentListener() {
            ...
            private void filter() {
                ...
                try {
                    ...
                    filters.add( RowFilter.regexFilter( "(?i)" + txtSearch.getText(), 0 ) );
    ...
    private Row getRow( int selectedRowNo ) {
        ...
        BigDecimal energy_energy_protein = ( BigDecimal ) getValueAt( selectedRowNo, 7 );
        BigDecimal energy_energy_alcohol = ( BigDecimal ) getValueAt( selectedRowNo, 8 );
        //Macronutrients
        BigDecimal macronutrients_fats_total = ( BigDecimal ) getValueAt( selectedRowNo, 9 );
        BigDecimal macronutrients_carbohydrates_digestible = ( BigDecimal ) getValueAt( selectedRowNo, 10 );
        BigDecimal macronutrients_protein_total = ( BigDecimal ) getValueAt( selectedRowNo, 11 );
        BigDecimal macronutrients_other_alcohol = ( BigDecimal ) getValueAt( selectedRowNo, 12 );
        //Protein
        BigDecimal protein_protein_total = ( BigDecimal ) getValueAt( selectedRowNo, 13 );
        BigDecimal protein_protein_complete = ( BigDecimal ) getValueAt( selectedRowNo, 14 );
        //Fats
        BigDecimal fats_fats_total = ( BigDecimal ) getValueAt( selectedRowNo, 15 );
        BigDecimal fats_fats_monounsaturated = ( BigDecimal ) getValueAt( selectedRowNo, 16 );
        BigDecimal fats_fats_polyunsaturated = ( BigDecimal ) getValueAt( selectedRowNo, 17 );
        BigDecimal fats_fats_saturated = ( BigDecimal ) getValueAt( selectedRowNo, 18 );
        BigDecimal fats_fats_cholesterol = ( BigDecimal ) getValueAt( selectedRowNo, 19 );
        //Saturated Fat
        BigDecimal sfa_fats_saturated = ( BigDecimal ) getValueAt( selectedRowNo, 20 );
        BigDecimal sfa_fats_hcsfa = ( BigDecimal ) getValueAt( selectedRowNo, 21 );
        BigDecimal sfa_fats_lauric = ( BigDecimal ) getValueAt( selectedRowNo, 22 );
        BigDecimal sfa_fats_myristic = ( BigDecimal ) getValueAt( selectedRowNo, 23 );
        BigDecimal sfa_fats_palmitic = ( BigDecimal ) getValueAt( selectedRowNo, 24 );
        BigDecimal sfa_fats_stearic = ( BigDecimal ) getValueAt( selectedRowNo, 25 );
        BigDecimal sfa_fats_cholesterol = ( BigDecimal ) getValueAt( selectedRowNo, 26 );
        //Polyunsaturated Fat
        BigDecimal pufa_fats_polyunsaturated = ( BigDecimal ) getValueAt( selectedRowNo, 27 );
        BigDecimal pufa_fats_linoleic = ( BigDecimal ) getValueAt( selectedRowNo, 28 );
        BigDecimal pufa_fats_linolenic = ( BigDecimal ) getValueAt( selectedRowNo, 29 );
        BigDecimal pufa_fats_epa = ( BigDecimal ) getValueAt( selectedRowNo, 30 );
        BigDecimal pufa_fats_dha = ( BigDecimal ) getValueAt( selectedRowNo, 31 );
        BigDecimal pufa_fats_lcn3pufa = ( BigDecimal ) getValueAt( selectedRowNo, 32 );
        //Carbohydrates
        BigDecimal carbs_carbohydrates_carbs_by_diff = ( BigDecimal ) getValueAt( selectedRowNo, 33 );
        BigDecimal carbs_carbohydrates_fiber = ( BigDecimal ) getValueAt( selectedRowNo, 34 );
        BigDecimal carbs_carbohydrates_fiber_insoluble = ( BigDecimal ) getValueAt( selectedRowNo, 35 );
        BigDecimal carbs_carbohydrates_fiber_soluble = ( BigDecimal ) getValueAt( selectedRowNo, 36 );
        BigDecimal carbs_carbohydrates_digestible = ( BigDecimal ) getValueAt( selectedRowNo, 37 );
        BigDecimal carbs_carbohydrates_starch = ( BigDecimal ) getValueAt( selectedRowNo, 38 );
        BigDecimal carbs_carbohydrates_sugars = ( BigDecimal ) getValueAt( selectedRowNo, 39 );
        BigDecimal carbs_carbohydrates_sucrose = ( BigDecimal ) getValueAt( selectedRowNo, 40 );
        BigDecimal carbs_carbohydrates_lactose = ( BigDecimal ) getValueAt( selectedRowNo, 41 );
        BigDecimal carbs_carbohydrates_fructose = ( BigDecimal ) getValueAt( selectedRowNo, 42 );
        BigDecimal carbs_carbohydrates_glucose = ( BigDecimal ) getValueAt( selectedRowNo, 43 );
        BigDecimal carbs_carbohydrates_glycemic_load = ( BigDecimal ) getValueAt( selectedRowNo, 44 );
        //Vitamins
        BigDecimal vitamins_vitamins_vitamin_a = ( BigDecimal ) getValueAt( selectedRowNo, 45 );
        BigDecimal vitamins_vitamins_vitamin_d = ( BigDecimal ) getValueAt( selectedRowNo, 46 );
        BigDecimal vitamins_vitamins_vitamin_e = ( BigDecimal ) getValueAt( selectedRowNo, 47 );
        BigDecimal vitamins_vitamins_vitamin_c = ( BigDecimal ) getValueAt( selectedRowNo, 48 );
        BigDecimal vitamins_vitamins_thiamin = ( BigDecimal ) getValueAt( selectedRowNo, 49 );
        BigDecimal vitamins_vitamins_riboflavin = ( BigDecimal ) getValueAt( selectedRowNo, 50 );
        BigDecimal vitamins_vitamins_niacin = ( BigDecimal ) getValueAt( selectedRowNo, 51 );
        BigDecimal vitamins_vitamins_vitamin_b6 = ( BigDecimal ) getValueAt( selectedRowNo, 52 );
        BigDecimal vitamins_vitamins_folate = ( BigDecimal ) getValueAt( selectedRowNo, 53 );
        BigDecimal vitamins_vitamins_vitamin_b12 = ( BigDecimal ) getValueAt( selectedRowNo, 54 );
        BigDecimal vitamins_vitamins_vitamin_k = ( BigDecimal ) getValueAt( selectedRowNo, 55 );
        BigDecimal vitamins_vitamins_pantothenic_acid = ( BigDecimal ) getValueAt( selectedRowNo, 56 );
        BigDecimal vitamins_vitamins_choline = ( BigDecimal ) getValueAt( selectedRowNo, 57 );
        //
        BigDecimal minerals_minerals_calcium = ( BigDecimal ) getValueAt( selectedRowNo, 58 );
        BigDecimal minerals_minerals_phosphorus = ( BigDecimal ) getValueAt( selectedRowNo, 59 );
        BigDecimal minerals_minerals_magnesium = ( BigDecimal ) getValueAt( selectedRowNo, 60 );
        BigDecimal minerals_minerals_iron = ( BigDecimal ) getValueAt( selectedRowNo, 61 );
        BigDecimal minerals_minerals_zinc = ( BigDecimal ) getValueAt( selectedRowNo, 62 );
        BigDecimal minerals_minerals_copper = ( BigDecimal ) getValueAt( selectedRowNo, 63 );
        BigDecimal minerals_minerals_manganese = ( BigDecimal ) getValueAt( selectedRowNo, 64 );
        BigDecimal minerals_minerals_selenium = ( BigDecimal ) getValueAt( selectedRowNo, 65 );
        //Electrolytes
        BigDecimal electrolytes_minerals_potassium = ( BigDecimal ) getValueAt( selectedRowNo, 66 );
        BigDecimal electrolytes_minerals_sodium = ( BigDecimal ) getValueAt( selectedRowNo, 67 );
        //Electrolytes
        BigDecimal phytonutrients_phytonutrients_flavonoids = ( BigDecimal ) getValueAt( selectedRowNo, 68 );
        BigDecimal phytonutrients_phytonutrients_carotenoids = ( BigDecimal ) getValueAt( selectedRowNo, 69 );
        BigDecimal phytonutrients_phytonutrients_phytosterols = ( BigDecimal ) getValueAt( selectedRowNo, 70 );
        BigDecimal phytonutrients_phytonutrients_anthocyanins = ( BigDecimal ) getValueAt( selectedRowNo, 71 );
        BigDecimal phytonutrients_phytonutrients_flavanols = ( BigDecimal ) getValueAt( selectedRowNo, 72 );
        BigDecimal phytonutrients_phytonutrients_flavanones = ( BigDecimal ) getValueAt( selectedRowNo, 73 );
        BigDecimal phytonutrients_phytonutrients_flavones = ( BigDecimal ) getValueAt( selectedRowNo, 74 );
        BigDecimal phytonutrients_phytonutrients_flavonols = ( BigDecimal ) getValueAt( selectedRowNo, 75 );
        BigDecimal phytonutrients_phytonutrients_isoflavones = ( BigDecimal ) getValueAt( selectedRowNo, 76 );
        BigDecimal phytonutrients_phytonutrients_beta_carotene = ( BigDecimal ) getValueAt( selectedRowNo, 77 );
        BigDecimal phytonutrients_phytonutrients_lutein_zeaxanthin = ( BigDecimal ) getValueAt( selectedRowNo, 78 );
        BigDecimal phytonutrients_phytonutrients_lycopene = ( BigDecimal ) getValueAt( selectedRowNo, 79 );
        BigDecimal phytonutrients_phytonutrients_caffeine = ( BigDecimal ) getValueAt( selectedRowNo, 80 );
        BigDecimal phytonutrients_phytonutrients_theobromine = ( BigDecimal ) getValueAt( selectedRowNo, 81 );
        BigDecimal phytonutrients_phytonutrients_gamma_tocopherol = ( BigDecimal ) getValueAt( selectedRowNo, 82 );
        //Cost
        BigDecimal other_other_cost = ( BigDecimal ) getValueAt( selectedRowNo, 83 );
        BigDecimal other_other_water = ( BigDecimal ) getValueAt( selectedRowNo, 84 );
        //
        Row row = new Row();
    ...
    public void roundDown() {
        ...
        getColumnModel().getColumn( 2 ).setCellRenderer( new RoundUpRenderer2() );
    }
