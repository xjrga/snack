 ...
 * @author jr
 */
public class TableElectrolytes extends JTable {

  private TableRowSorter sorter;
  private JTextField searchField;
  private DataModel dm;

  public TableElectrolytes() {
  ...
  private Row getRow(int selectedRowNo) {
    ...
    BigDecimal other_water = (BigDecimal) getValueAt(selectedRowNo, 4);
    BigDecimal minerals_potassium = (BigDecimal) getValueAt(selectedRowNo, 5);
    BigDecimal minerals_sodium = (BigDecimal) getValueAt(selectedRowNo, 6);
    Row row = new Row();
    row.setMixid(mixid);
