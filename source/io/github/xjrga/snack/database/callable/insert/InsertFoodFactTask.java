...
public class InsertFoodFactTask implements Callable<Boolean> {
	...
	public Boolean call() throws Exception {
		...
		try {
			...
			execute( foodid, food.getCarbohydrates_carbs_by_diff_nutr_no(),
					food.getCarbohydrates_carbs_by_diff_quantity() );
			execute( foodid, food.getCarbohydrates_fiber_insoluble_nutr_no(),
					food.getCarbohydrates_fiber_insoluble_quantity() );
			execute( foodid, food.getCarbohydrates_fiber_soluble_nutr_no(),
			...
			execute( foodid, food.getCarbohydrates_glycemic_load_nutr_no(),
			...
			execute( foodid, food.getPhytonutrients_anthocyanins_nutr_no(),
			...
			execute( foodid, food.getPhytonutrients_beta_carotene_nutr_no(),
					food.getPhytonutrients_beta_carotene_quantity() );
			execute( foodid, food.getPhytonutrients_carotenoids_nutr_no(),
			...
			execute( foodid, food.getPhytonutrients_flavanones_nutr_no(),
			...
			execute( foodid, food.getPhytonutrients_flavonoids_nutr_no(),
			...
			execute( foodid, food.getPhytonutrients_isoflavones_nutr_no(),
					food.getPhytonutrients_isoflavones_quantity() );
			execute( foodid, food.getPhytonutrients_lutein_zeaxanthin_nutr_no(),
			...
			execute( foodid, food.getPhytonutrients_phytosterols_nutr_no(),
			...
			execute( foodid, food.getVitamins_pantothenic_acid_nutr_no(),
