...
public class InsertFoodFactTask implements Callable<Boolean> {
  ...
  public Boolean call() throws Exception {
    ...
    try {
      ...
      execute(
          foodid, food.getCarbohydrates_fiber_nutr_no(), food.getCarbohydrates_fiber_quantity());
      execute(
          foodid,
          food.getCarbohydrates_fructose_nutr_no(),
          food.getCarbohydrates_fructose_quantity());
      execute(
          foodid,
          food.getCarbohydrates_glucose_nutr_no(),
          food.getCarbohydrates_glucose_quantity());
      execute(
          foodid,
      ...
      execute(
          foodid,
          food.getCarbohydrates_lactose_nutr_no(),
          food.getCarbohydrates_lactose_quantity());
      execute(
          foodid, food.getCarbohydrates_starch_nutr_no(), food.getCarbohydrates_starch_quantity());
      execute(
          foodid,
          food.getCarbohydrates_sucrose_nutr_no(),
          food.getCarbohydrates_sucrose_quantity());
      execute(
          foodid, food.getCarbohydrates_sugars_nutr_no(), food.getCarbohydrates_sugars_quantity());
      ...
      execute(
          foodid, food.getFats_monounsaturated_nutr_no(), food.getFats_monounsaturated_quantity());
      ...
      execute(
          foodid, food.getFats_polyunsaturated_nutr_no(), food.getFats_polyunsaturated_quantity());
      ...
      execute(
          foodid, food.getMinerals_phosphorus_nutr_no(), food.getMinerals_phosphorus_quantity());
      ...
      execute(
          foodid,
          food.getPhytonutrients_caffeine_nutr_no(),
          food.getPhytonutrients_caffeine_quantity());
      execute(
          foodid,
      ...
      execute(
          foodid,
          food.getPhytonutrients_flavanols_nutr_no(),
          food.getPhytonutrients_flavanols_quantity());
      execute(
          foodid,
          food.getPhytonutrients_flavanones_nutr_no(),
          food.getPhytonutrients_flavanones_quantity());
      execute(
          foodid,
          food.getPhytonutrients_flavones_nutr_no(),
          food.getPhytonutrients_flavones_quantity());
      execute(
          foodid,
          food.getPhytonutrients_flavonoids_nutr_no(),
          food.getPhytonutrients_flavonoids_quantity());
      execute(
          foodid,
          food.getPhytonutrients_flavonols_nutr_no(),
          food.getPhytonutrients_flavonols_quantity());
      execute(
          foodid,
      ...
      execute(
          foodid,
          food.getPhytonutrients_lycopene_nutr_no(),
          food.getPhytonutrients_lycopene_quantity());
      execute(
          foodid,
      ...
      execute(
          foodid, food.getVitamins_vitamin_b12_nutr_no(), food.getVitamins_vitamin_b12_quantity());
      execute(
          foodid, food.getVitamins_vitamin_b6_nutr_no(), food.getVitamins_vitamin_b6_quantity());
      ...
      execute(
          foodid,
          food.getVitamins_pantothenic_acid_nutr_no(),
          food.getVitamins_pantothenic_acid_quantity());
      execute(
          foodid, food.getVitamins_riboflavin_nutr_no(), food.getVitamins_riboflavin_quantity());
