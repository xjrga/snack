...
public class MinimumNutrientRequirements {
  ...
  public double getCarbohydrateLow() {
    ...
    /*
     * Gamble, James L. "Physiological information gained from studies on the life raft ration."
  ...
  public double getCarbohydrateMedium() {
    ...
    /*
     * Flatt, Jean‐Pierre. "Macronutrient composition and food selection." Obesity research 9.S11
     * (2001): 256S-262S.
     */
    return 100.0D;
  }
  ...
  /*
   * Bistrian, Bruce R. "Clinical use of a protein-sparing modified fast." JAMA 240.21 (1978):
   * 2299-2302.
   */
  /*
   * Brosnan, J. T. "Comments on metabolic needs for glucose and the role of gluconeogenesis."
