...
public class FoodNutrientRhs implements SqlCallMixid<Map<String, Object>> {

  private final Connection connection;

  public FoodNutrientRhs() {
  ...
  public List<Map<String, Object>> execute(String mixid) {
    ...
    try (CallableStatement proc = connection.prepareCall("{CALL public.foodnutrient_rhs( ? )}")) {
