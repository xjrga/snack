                    ...
                    if ( !data.isBlank() ) {
                        switch ( startEvent ) {
                            ...
                            case "group-id":
                                switch ( mainEvent ) {
                                    case "group" ->
                                        group.setGroupid( data );
                                    case "groupfood" ->
                                        groupfood.setGroupid( data );
                                    case "group_quantity" ->
                                        group_constraint.setGroupid( data );
                                }
                                break;
                            case "group-name":
                                group.setName( data );
                            ...
                            case "nutrient-id":
                                switch ( mainEvent ) {
                                    ...
                                    case "group_quantity" ->
                                        group_constraint.setNutrientid( data );
                                }
                                break;
                            case "lifestage-id":
                                switch ( mainEvent ) {
                                    case "mix" ->
                                        mix.setLifestageid( Integer.valueOf( data ) );
                                }
                                break;
                            case "nutrient-id_a":
                                switch ( mainEvent ) {
                            ...
                            case "relationship-id":
                                switch ( mainEvent ) {
                                    ...
                                    case "group_quantity" ->
                                        group_constraint.setRelationshipid( Integer.valueOf( data ) );
                                }
                                break;
                            case "a":
                                switch ( mainEvent ) {
                            ...
                            case "b":
                                switch ( mainEvent ) {
                                    ...
                                    case "group_quantity" ->
                                        group_constraint.setB( new BigDecimal( data ) );
                                }
                                break;
                            case "food-name":
